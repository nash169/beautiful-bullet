#ifndef BEAUTIFUL_BULLET_GRAPHICS_MAGNUM_GRAPHICS2_HPP
#define BEAUTIFUL_BULLET_GRAPHICS_MAGNUM_GRAPHICS2_HPP
...
namespace beautiful_bullet {
    namespace graphics {
        class MagnumGraphics2 : public AbstractGraphics2 {
        public:
            MagnumGraphics2() : AbstractGraphics2()
            {
                int argc = 0;
                char** argv = NULL;
            ...
            bool init(Simulator2& simulator) override
            {
                // Set camera pose
...
#endif // BEAUTIFUL_BULLET_GRAPHICS_MAGNUM_GRAPHICS2_HPP