#ifndef BEAUTIFUL_BULLET_SIMULATOR2_HPP
#define BEAUTIFUL_BULLET_SIMULATOR2_HPP
...
#include "beautiful_bullet/graphics/AbstractGraphics2.hpp"
...
namespace beautiful_bullet {
    ...
    class Simulator2 {
    public:
        Simulator2() : _timeStep(1e-3), _ground(false)
        {
        ...
        /* Set graphics */
        Simulator2& setGraphics(std::unique_ptr<graphics::AbstractGraphics2> graphics)
        {
        ...
        Simulator2& add(Body& body, Args&... args) // move the agent
        {
    ...
    protected:
        ...
        /* Graphics */
        std::unique_ptr<graphics::AbstractGraphics2> _graphics;
...
#endif // BEAUTIFUL_BULLET_SIMULATOR2_HPP