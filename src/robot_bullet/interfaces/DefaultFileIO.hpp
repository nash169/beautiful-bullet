...
namespace robot_bullet {
    namespace interfaces {
        struct DefaultFileIO : public FileIOInterface {
            ...
            DefaultFileIO(int fileIOType = 0, const char* pathPrefix = 0)
                : FileIOInterface(fileIOType, m_prefix),
                  m_numFileHandles(0)
            {
                m_prefix[0] = 0;
                if (pathPrefix) {
            ...
            {
                return utils::ResourcePath::findResourcePath(fileName, relativeFileName, relativeFileNameSizeInBytes, DefaultFileIO::FileIOPluginFindFile, this) > 0;
            }
